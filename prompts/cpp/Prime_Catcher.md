# C++ Engine Implementation: Prime Catcher
...
### Card Text
> Switch in 1 of your opponent's Benched Pokemon to the Active Spot. If you do, switch your Active Pokemon with 1 of your Benched Pokemon.
...
### File: `cpp_engine/src/cards/trainers/items/prime_catcher.cpp`

```cpp
/**
 * Prime Catcher - Trainer Item (TARGETED Pattern)
 *
 * Card text:
 * "Switch in 1 of your opponent's Benched Pokemon to the Active Spot. If you do, switch your Active Pokemon with 1 of your Benched Pokemon."
 * "You may play any number of Item cards during your turn."
...
TrainerResult execute_prime_catcher(TrainerContext& ctx) {
    ...
    if (!can_play_prime_catcher(state, player_id)) {
        result.success = false;
        result.effect_description = "Cannot play Prime Catcher";
        return result;
    }
    ...
    result.success = true;
    result.effect_description = "Prime Catcher effect";
    return result;
}
...
```cpp
#include "cards/trainers/items/prime_catcher.cpp"

void register_all_trainers(LogicRegistry& registry) {
    // ... existing registrations ...
    trainers::register_prime_catcher(registry);
}
```
...
### Core Implementation
- [ ] Implement `can_play_prime_catcher()` with proper validation
...
- [ ] Implement `execute_prime_catcher()` using effect builders
  - Use appropriate `effects::` helper
  - Set correct count/min_count
  - Build correct filter criteria
- [ ] Register all card IDs: `sv5-157, sv8pt5-119`
